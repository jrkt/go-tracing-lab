...
func startconvo(span *trace.Span, w http.ResponseWriter, r *http.Request) {
	...
	err := exec.Command("cvlc", "--play-and-exit", os.Getenv("GOPATH")+"/src/github.com/jrkt/go-tracing-lab/audio/richard-1.mp3").Run()
	if err != nil {
...
func richard2(span *trace.Span, w http.ResponseWriter, r *http.Request) {
	...
	err := exec.Command("cvlc", "--play-and-exit", os.Getenv("GOPATH")+"/src/github.com/jrkt/go-tracing-lab/audio/richard-2.mp3").Run()
	if err != nil {
		log.Fatalln("failed to play audio:", err)
	}
...
func richard3(span *trace.Span, w http.ResponseWriter, r *http.Request) {
	...
	err := exec.Command("cvlc", "--play-and-exit", os.Getenv("GOPATH")+"/src/github.com/jrkt/go-tracing-lab/audio/richard-3.mp3").Run()
	if err != nil {
		log.Fatalln("failed to play audio:", err)
	}
...
func richard4(span *trace.Span, w http.ResponseWriter, r *http.Request) {
	...
	err := exec.Command("cvlc", "--play-and-exit", os.Getenv("GOPATH")+"/src/github.com/jrkt/go-tracing-lab/audio/richard-4.mp3").Run()
	if err != nil {
		log.Fatalln("failed to play audio:", err)
	}
